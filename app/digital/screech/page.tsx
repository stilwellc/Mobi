    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative min-h-[400px] flex items-center justify-center px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-8">
            <div className="w-2 h-2 bg-mobi-burgundy rounded-full mx-auto" />
          </div>
          ...
          <Link href="/" className="inline-flex items-center text-zinc-400 hover:text-[#EDE8D0] transition-colors">
