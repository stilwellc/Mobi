...
export default function PrintsPage() {
  ...
  const indexItems: PlateIndexItem[] = [
    { id: 'plate-i', no: 'I', label: 'Describe' },
    { id: 'plate-ii', no: 'II', label: 'Model' },
    { id: 'plate-iii', no: 'III', label: 'Print' },
    { id: 'plate-iv', no: 'IV', label: 'The Setup' },
    ...prints.map((print, i) => ({
      id: `plate-${LIB_NUMERALS[i].toLowerCase()}`,
      no: LIB_NUMERALS[i],
      label: print.name,
    })),
  ];
  ...
  return (
    <div className="rail" style={{ paddingBlock: 'var(--space-5) var(--space-6)' }}>
      ...
      <div className="folio">
        {/* Running table of plates — desktop only */}
          ...
          <section aria-label="The pipeline">
            ...
            <div className="f-grid">
              ...
              <Reveal className="f-cell">
                <Plate id="plate-i" no="I" role="Describe" caption="Input · plain language" xref={<>&rarr; Plate II</>}>
                  <p className="f-quote">
              ...
              {/* PLATE II — the generated model, typeset like a source plate */}
              <Reveal className="f-cell" delay={90}>
                <Plate id="plate-ii" no="II" role="Model" caption="CadQuery · generated by the skill" xref={<>&rarr; Plate III</>}>
              ...
              <Reveal className="f-cell f-full">
                <Plate
                  ...
                  xref={
                    ...
                    >
                      In the library &middot; cf. Plate V{' '}
