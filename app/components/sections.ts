...
export const sections: Section[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        meta: { year: '2025', stack: 'Node.js · PostgreSQL', status: 'Live' },
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: '3D Prints', tag: 'Text → Print',
        description: 'An AI text-to-print pipeline — describe an object, get a print-ready model — and the growing library of lighting and furniture it produces.',
        ...
        meta: { year: '2025 —', material: 'Text → CAD → PLA', status: 'Growing' },
      },
    ],
  },
];
