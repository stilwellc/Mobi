  ...
  return (
    <span className="logo-mark" style={{ width: size, height: size }} aria-hidden="true">
      ...
      <svg viewBox="0 0 100 100" fill="none">
        <path d={MOBIUS_EDGE} stroke="currentColor" strokeWidth="4" strokeLinecap="round" opacity="0.9" />
        <path className="logo-pulse" d={MOBIUS_EDGE} stroke="var(--color-accent-gold)" strokeWidth="5.5" strokeLinecap="round" />
